...
function chat () {
    ...
    async function intro () {
        ...
        vous vous connectiez. C’est dingue ce que les journées passent vite, 
        je n’ai même plus le temps de voir mes ami.es en ce moment. Et vous, 
        comment allez-vous ? </span>`;
